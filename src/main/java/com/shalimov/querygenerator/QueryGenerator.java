...
public class QueryGenerator {
    ...
    private List<String> getAllColumnsNames(Class<?> clazz) {
    ...
    private String getAllValuesOfFields(Object value) {
    ...
    private String getColumnIdValueAndName(Object value) {
        StringJoiner columnIdValueAndName = new StringJoiner(", ");
        Class<?> clazz = value.getClass();
        for (Field field : clazz.getDeclaredFields()) {
            if ((field.getName().compareTo("id") == 0 && field.getAnnotation(Column.class) != null)) {
    ...
    private String getColumnsNamesAndValues(Object value) {
